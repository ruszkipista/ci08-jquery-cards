$(document).ready(function () {
	...
	$("#stream2_btn").click(function () {
		$(".stream1").removeClass('highlight_stream');
		$(".stream2").removeClass('highlight_stream').addClass('highlight_stream');
		$(".stream3").removeClass('highlight_stream');
	});
	$("#stream3_btn").mouseenter(function () {
		$(".stream1").removeClass('highlight_stream');
		$(".stream2").removeClass('highlight_stream');
		$(".stream3").removeClass('highlight_stream').addClass('highlight_stream');
	});
	...
	// Underline all h2 elements with inline styling
	$("h2").css("text-decoration", "underline");
	// Underline all h2 elements with assigning CSS class
	$("h2").addClass("underline");

	// Add a solid border of 1px and a color of `#ccc` to all unordered lists
	$("ul").css("border", "solid 1px #ccc");
	// Draw border around every ul elements with assigning CSS class
	$("ul").addClass("border");
